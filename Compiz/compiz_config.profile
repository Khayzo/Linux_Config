...
s0_dec_button = <Control><Primary><Alt>Button4
s0_inc_button = <Control><Primary><Alt>Button5
s0_animtime = 150
...
s0_trigger_max_key = <Control><Primary><Alt>m
...
[decor]
s0_active_shadow_radius = 9,000000
...
s0_initiate_edge = 
s0_initiate_key = <Control><Primary><Alt>Up
s0_initiate_button = Disabled
s0_initiate_all_edge = 
s0_initiate_all_button = Disabled
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;imgsvg;scale;switcher;imgjpeg;imgpng;mousepoll;obs;grid;staticswitcher;resize;gnomecompat;commands;mblur;wall;addhelper;place;shelf;shift;thumbnail;move;
...
s0_outputs = 640x480+0+0;;1366*768+0+0;
...
s0_minimize_window_key = <Control><Primary><Alt>KP_Subtract
...
[opacify]
s0_toggle_key = <Control><Primary><Alt>q
...
s0_skydome = true
s0_skydome_image = /home/khayzo/Images/grub_background.png
...
s0_put_restore_key = <Control><Primary><Alt>KP_Decimal
...
s0_outline_color = #0047fb9f
s0_fill_color = #0047fb4f
...
s0_open_durations = 350;
s0_open_matches = (type=Normal | Dialog | ModalDialog | Unknown);
s0_open_options = ;
s0_open_random_effects = 
s0_close_effects = animationaddon:Burn;
s0_close_durations = 350;
...
s0_border_color = #0083fb9f
s0_fill_color = #006afb19
s0_normal_match = 
s0_outline_match = 
s0_rectangle_match = 
s0_stretch_match = 
...
[vpswitch]
s0_begin_key = <Control><Primary><Alt>s
...
[expo]
s0_expo_key = <Control><Primary><Alt>s
